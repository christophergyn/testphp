 ...
 */
class ProdutoComplemento extends \Application\Entity\ProdutoComplemento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'dataCadastro', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'status', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'estacao', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'dupdate', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'dinsert', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'ddelete', '' . "\0" . 'Application\\Entity\\ProdutoComplemento' . "\0" . 'tipoComplemento'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProdutoComplemento $proxy) {
    ...
    public function setTipoComplemento($tipoComplemento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoComplemento', [$tipoComplemento]);

        return parent::setTipoComplemento($tipoComplemento);
    }
    ...
    public function getTipoComplemento()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoComplemento', []);

        return parent::getTipoComplemento();
    }
