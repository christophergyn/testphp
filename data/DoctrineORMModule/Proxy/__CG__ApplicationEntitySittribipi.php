 ...
 */
class Sittribipi extends \Application\Entity\Sittribipi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'codigo', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'data', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'estacao', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'dupdate', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'dinsert', '' . "\0" . 'Application\\Entity\\Sittribipi' . "\0" . 'ddelete'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sittribipi $proxy) {
