 ...
 */
class Moeda extends \Application\Entity\Moeda implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'codMoeda', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'descMoeda', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'dataMoeda', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'ddelete', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\Moeda' . "\0" . 'estacao'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Moeda $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDescMoeda($descMoeda)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescMoeda', [$descMoeda]);

        return parent::setDescMoeda($descMoeda);
    }

    /**
     * {@inheritDoc}
     */
    public function getDescMoeda()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDescMoeda', []);

        return parent::getDescMoeda();
    }

    /**
     * {@inheritDoc}
     */
    public function setDataMoeda($dataMoeda)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDataMoeda', [$dataMoeda]);

        return parent::setDataMoeda($dataMoeda);
    }

    /**
     * {@inheritDoc}
     */
    public function getDataMoeda()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDataMoeda', []);

        return parent::getDataMoeda();
    }
