...
class Estado extends \Application\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'sigla', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'data', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'iva', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'ddelete', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'dupdate', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'dinsert', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'estacao', '' . "\0" . 'Application\\Entity\\Estado' . "\0" . 'aliqIcms'];
        }
    ...
    public function setAliqIcms($aliqIcms)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAliqIcms', [$aliqIcms]);

        return parent::setAliqIcms($aliqIcms);
    }
    ...
    public function getAliqIcms()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAliqIcms', []);

        return parent::getAliqIcms();
    }
