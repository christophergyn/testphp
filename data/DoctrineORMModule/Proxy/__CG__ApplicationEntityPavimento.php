 ...
 */
class Pavimento extends \Application\Entity\Pavimento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'dataCadastro', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'status', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'estacao', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'dupdate', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'dinsert', '' . "\0" . 'Application\\Entity\\Pavimento' . "\0" . 'ddelete'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pavimento $proxy) {
