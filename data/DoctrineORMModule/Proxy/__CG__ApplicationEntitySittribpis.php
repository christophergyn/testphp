 ...
 */
class Sittribpis extends \Application\Entity\Sittribpis implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'codigo', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'data', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'estacao', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'dupdate', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'dinsert', '' . "\0" . 'Application\\Entity\\Sittribpis' . "\0" . 'ddelete'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sittribpis $proxy) {
