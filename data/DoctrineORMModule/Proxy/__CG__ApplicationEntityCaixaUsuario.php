 ...
 */
class CaixaUsuario extends \Application\Entity\CaixaUsuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'codCaixa', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'descCaixa', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'dataCaixa', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'dataOperacao', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'programa', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'estacao', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'usuario', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'dinsert', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'dupdate', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'ddelete', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'codContab', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'codFil', '' . "\0" . 'Application\\Entity\\CaixaUsuario' . "\0" . 'codUsuar'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CaixaUsuario $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDescCaixa($descCaixa)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescCaixa', [$descCaixa]);

        return parent::setDescCaixa($descCaixa);
    }

    /**
     * {@inheritDoc}
     */
    public function getDescCaixa()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDescCaixa', []);

        return parent::getDescCaixa();
    }
    ...
    public function setDataCaixa($dataCaixa)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDataCaixa', [$dataCaixa]);

        return parent::setDataCaixa($dataCaixa);
    }
    ...
    public function getDataCaixa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDataCaixa', []);

        return parent::getDataCaixa();
    }
    ...
    public function setDataOperacao($dataOperacao)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDataOperacao', [$dataOperacao]);

        return parent::setDataOperacao($dataOperacao);
    }
    ...
    public function getDataOperacao()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDataOperacao', []);
     ...
     * {@inheritDoc}
     */
    public function setCodContab(\Application\Entity\Contabil $codContab = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodContab', [$codContab]);

        return parent::setCodContab($codContab);
    }

    /**
     * {@inheritDoc}
     */
    public function getCodContab()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodContab', []);

        return parent::getCodContab();
    }
